    ...
    <div className="max-w-[1180px] mx-auto px-5 pt-5 pb-12">
      ...
      <main>
        ...
        {showCrisis && (
          <aside
            id="crisis-banner"
            className="crisis-banner mt-8"
            role="alert"
            aria-live="assertive"
          >
            <h3 className="font-serif text-[1.15rem] font-semibold mb-2.5 text-[#ffd59e]">
              You matter deeply.
            </h3>
            <p className="mb-3 text-[0.92rem] text-[var(--ink-muted)] leading-relaxed">
              If you&apos;re in crisis or having thoughts of self-harm, please
              reach out:
            </p>
            <ul className="list-none m-0 mb-3 p-0 grid gap-2">
              <li className="text-[0.92rem]">
                <strong className="text-[#ffd59e]">
                  988 Suicide &amp; Crisis Lifeline
                </strong>{' '}
                &mdash; Call or text 988
              </li>
              <li className="text-[0.92rem]">
                <strong className="text-[#ffd59e]">Crisis Text Line</strong>{' '}
                &mdash; Text HOME to 741741
              </li>
              <li className="text-[0.92rem]">
                <strong className="text-[#ffd59e]">Emergency</strong> &mdash;
                Call 911
              </li>
            </ul>
            <p className="text-[0.82rem] text-[var(--ink-subtle)]">
              This tool provides spiritual encouragement and is not a substitute
