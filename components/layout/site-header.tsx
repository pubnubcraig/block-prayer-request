    ...
    <header className="flex items-center justify-between gap-4 pb-7 max-[520px]:flex-col max-[520px]:items-start">
      ...
      <div className="flex items-center gap-5">
        ...
        <nav className="hidden min-[521px]:flex items-center gap-5 text-[0.85rem]">
          ...
          <Link href="/prayer-wall" className="inline-flex items-center gap-1.5 text-[0.85rem] font-semibold text-salt bg-seateal px-3 py-1 rounded-[var(--radius-sm)] no-underline hover:bg-oceanblue transition-colors">Prayer Wall</Link>
        ...
        <div className="relative min-[521px]:hidden">
          ...
          {menuOpen && (
            <nav className="absolute right-0 top-11 z-50 card grid gap-1 min-w-[180px] py-3 px-4">
              ...
              <Link href="/prayer-wall" onClick={() => setMenuOpen(false)} className="inline-flex items-center gap-1.5 text-[0.85rem] font-semibold text-salt bg-seateal px-3 py-1 rounded-[var(--radius-sm)] no-underline hover:bg-oceanblue transition-colors">Prayer Wall</Link>
